...
class TestRationalMethods(unittest.TestCase):
    ...
    def test_add_pos(self):
        ...
        self.assertEqual(result,Rational(4,5),"Error in Adding Positive Fracrtionss")
    def test_add_neg(self):
        result = Rational(4,5)-Rational(3,5)
        self.assertEqual(result,Rational(1,5),"Error in Adding Negative Fracrtions")
    #Testing Substraction
    def test_sub_pos(self):
        result = Rational(4,5)-Rational(2,5)
        self.assertEqual(result,Rational(2,5),"Error in Substracting Positive Fracrtions")
    def test_sub_neg(self):
        result = Rational(2,5)-Rational(-2,5)
        self.assertEqual(result,Rational(4,5),"Error in Substracting Negative Fracrtions")
